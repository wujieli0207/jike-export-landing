...
const CTA = () => {
  return (
    <SectionWrapper className="overflow-hidden p-72">
        ...
        >
          <div className="flex-none max-w-xl mt-12 space-y-3 delay-200 duration-300 ease-in md:mt-0">
            ...
            <p className="text-gray-600">
              ...
              captures the entire project lifecycle, from backlog to release.
              With a variety of features. Allow your teams to collaborate
              effectively on projects and stay on top of deadlines.
            </p>
            <div className="pt-1">
              <NavLink
                href="#get-started"
                className="inline-block w-full font-medium text-sm text-white bg-sky-500 hover:bg-sky-600 active:bg-sky-700 shadow rounded-lg sm:w-auto"
              >
                Get free trial
              </NavLink>
            </div>
